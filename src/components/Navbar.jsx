    ...
    <nav className="navbar">
      <div className="container flex justify-between items-center" style={{ height: '100%' }}>
        ...
        <div className="navbar-search">
          ...
          <span className="divider"></span>
          <button className="search-btn search-add-guests" style={{lineHeight: 1.2, paddingRight: '8px'}}>Add<br/>guests</button>
        ...
        <div className="navbar-user-menu flex items-center gap-2">
          <a href="#" className="host-link" style={{lineHeight: 1.2, padding: '12px 8px'}}>Become a<br/>host</a>
